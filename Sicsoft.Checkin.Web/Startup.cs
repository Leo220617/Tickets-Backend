...
.ConfigureHttpClient(c => c.BaseAddress = new Uri($"{Configuration["UrlWebApi"]}/api/Tiquetes"))
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();

            services.AddRefitClient<ICrudApi<EmpresasViewModel, int>>()
.ConfigureHttpClient(c => c.BaseAddress = new Uri($"{Configuration["UrlWebApi"]}/api/Empresas"))
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();

            services.AddRefitClient<ICrudApi<Adjuntos, int>>()
...
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();
            ...
            services.AddRefitClient<ICrudApi<TipoActividadesViewModel, int>>()
.ConfigureHttpClient(c => c.BaseAddress = new Uri($"{Configuration["UrlWebApi"]}/api/TipoActividades"))
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();
